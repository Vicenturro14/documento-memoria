...
Como se mencionó en la sección \ref{sec:intro:despliegue}, el despliegue se realizará en
los servidores del DCC para que pueda ser utilizada por la coordinación de titulación.
Para ello, durante todo el desarrollo del sistema se utilizaron contenedores de Docker
con Docker Compose para coordinar la creación de los contenedores de la base de datos
