...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.4\textwidth]{imagenes/implementaciones/grafico_evaluadores.png}
...
de un estudiante, ya que que se decidió que esto sería parte de otra memoria que incorpora
...
se parte guardan los cursos en el modelo Curso, los estudiantes en el modelo Estudiante,
...
no es algo incorporado por esta memoria en el Sistema de Titulación y el SSM, ambos sistemas
ya lo utilizaban.
