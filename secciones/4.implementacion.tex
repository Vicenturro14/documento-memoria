...
Luego, por cada comisión se obtiene al estudiante del modelo Estudiante y al guía, coguía
e integrantes del modelo Profesor. Al igual que con los cursos, se registran en la base
de datos si estos no existen. Tanto los estudiantes como los profesores se buscan por su
nombre completo, pues este se define como único en la base de datos. Es importante mencionar
que al buscar por el nombre completo, este debe ser normalizado, que en este caso significa que
todas las palabras del string deben comenzar con mayúscula, ya que los modelos de
Profesor y Estudiante realizan esta normalización al momento de guardarlos en la base de datos.
Esto implica que apellidos como "De la Fuente" serán guardados como "De La Fuente". Se
obtiene o crea la memoria. Si la memoria se crea, se agregan al guía, coguía
e integrantes como miembros de la comisión con su respectivo rol. Mientras que si la memoria ya existe,
se eliminan los miembros anteriores y se agregan los nuevos que vienen en el JSON. Este comportamiento
se implementó así, para que se puedan corregir los miembros de la comisión a través de la API.
