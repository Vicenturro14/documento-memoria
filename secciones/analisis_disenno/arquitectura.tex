...
Los módulos Core y Kernel actúan como base transversal. Core contiene la configuración y
funcionalidades utilizadas por todo el sistema, mientras que Kernel aporta con modelos base.
Por su parte, el módulo de Servicios gestiona las notificaciones, mientras que el de Docencia se ocupa de los periodos
...
De los módulos mencionados anteriormente, los módulos Kernel, Core, Investigación,
Servicios, Departamento, Docencia y Titulación se encontraban en producción antes de este
trabajo. Cabe destacar que Departamento, Docencia y Titulación fueron modificados durante
esta memoria. Por otra parte, los módulos de Evaluación, Trabajo de Título y Comisiones
fueron llevados a producción por este trabajo.
