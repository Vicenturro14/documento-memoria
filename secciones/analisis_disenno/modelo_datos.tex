...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.54\linewidth]{imagenes/diagramas/titulacion.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\linewidth]{imagenes/diagramas/comisiones.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.36\linewidth]{imagenes/diagramas/modelo_docencia_nuevo.png}
