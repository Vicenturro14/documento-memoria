\begin{resumen}
    ...
    con importancia, pues son las comisiones examinadoras las que evalúan los trabajos de título y
    ...
    CC5401 Ingeniería de Software II. Al piloto se le agregaron funcionalidades como
    ...
    Tanto la extensión del sistema de titulación como la adaptación del SSM fueron desplagadas primero
    en un servidor de test para evaluar su funcionalidad, para luego ser desplegadas en el servidor de
    producción del DCC.

    Para evaluar la solucion implentada, se utilizó el módulo de comisiones examinadoras
