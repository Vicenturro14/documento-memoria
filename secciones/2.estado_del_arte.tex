...
\section{Sistema de Seguimiento de Memorias}\label{sec:sa:sistema}
...
la vista principal del SSM. Este sistema se encuentra en producción desde julio de 2025 y
...
caracter \texttt{;} (punto y coma) como separador, mientras que el SSM requiere que el
