...
Antes de comenzar este trabajo existían varios proyectos y sistemas relacionados con el
proceso de titulación en el DCC. Algunos de estos proyectos sirvieron para el desarrollo
de esta memoria, ya sea como insumo o como inspiración, mientras que otros directamente
no fueron utilizados. Dentro de estos se encuentran el Sistema de Titulación del DCC, el
Sistema de Seguimiento de Memorias \cite{SistemaMonitoreoMemorias}, un sistema de
recomendación de comisiones \cite{SistemaRecomendacion} y un sistema de asignación de
comisiones desarrollado por un grupo del curso CC5401 Ingeniería de Software II. A
continuación se describen las características y las limitaciones de estos sistemas,
relacionadas con la asignación de comisiones examinadoras.
...
Como estudiante, se pueden ver un listado de temas para trabajos de título como se muestra
en la figura \ref{fig:titulacion_temas}, solicitar la inscripción en un tema, subir
propuestas su memoria y su informe final del curso Introducción al Trabajo de Título.
Además, tal como se puede ver en la figura \ref{fig:titulacion_ficha}, se puede ver su ficha personal, que incluye la etapa actual del trabajo de título,
el tema del trabajo de título junto a su guía. Además, se puede descargar la propuesta de
memoria y el informe final de Introducción al
...
Originalmente, las funcionalidades de este sistema están enfocadas en el ramo Introducción
...
a la coordinación de estudios monitorear los plazos de entrega de los informes finales de
Trabajo de Título y gestionar la corrección de los mismos. Para realizar esta tarea, el
sistema requiere saber cuáles son las comisiones examinadoras asignadas a cada trabajo de
título y el método que se utiliza para obtener estos datos es que la coordinadora de estudios
los ingrese, por lo que el sistema permite agregar, eliminar y modificar memorias, estudiantes,
profesores y miembros de comisiones examinadoras. El ingreso de esta información es realizado por la
coordinación de estudios, una vez la coordinación de titulación realice la asignación de las
...
que fue desarrollado para que sea utilizado por la coordinación de estudios
...
la vez como se puede apreciar en la figura \ref{fig:smm_form}, se debe ingresar un miembro de
la comisión a la vez, ingresando el profesor y el rol que tendrá, es decir, si es guía,
coguía o integrante de la comisión. Como por cada comisión se requieren al menos 2 integrantes además de los guías, se debe llenar al menos tres veces
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\linewidth]{imagenes/ingsoft_comisiones.png}
...
carácter \texttt{;} (punto y coma) como separador, mientras que el SSM requiere que ese
carácter sea utilizado para separar los nombres y los correos de los integrantes de la
...
miembros a una comisión en un mismo formulario, como se aprecia en la figura
\ref{subfig:ingsoft_agregar}. Además, en el formulario se permite
