...
finales de Trabajo de Título y gestionar la corrección de los mismos. Para realizar esta 
tarea, el sistema requiere saber cuales son las comisiones examinadoras asignadas a cada 
trabajo de título y el método que se utiliza para obtenerlos es que el usuario los ingrese,
por lo que el sistema permite agregar, eliminar y modificar memorias, estudiantes, profesores 
