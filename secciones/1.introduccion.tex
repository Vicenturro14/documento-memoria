...
no hay una base de datos de 100\% correcta de estudiantes que requieran
comisiones.
...
el proceso de titulación, como el sistema de titulación y el sistema de monitoreo de
memorias.
...
\begin{itemize}
    ...
    titulación, en particular con el sistema de titulación y el sistema de monitoreo de
    memorias. 
    \item Dejar la herramienta desarrollada en producción.
\end{itemize}

\section{Solución Propuesta}
Para poder cumplir los objetivos descritos, se
propone realizar una extensión del sistema de asignación de comisiones examinadoras 
desarrollado por un equipo del curso CC5401 Ingeniería de Software II. Como se mencionó
en la sección \ref{sec:sa:asignacion}, el sistema de asignación de comisiones
examinadoras es un sistema piloto y una extensión del sistema de titulación del DCC, que
agrega un módulo para asignar comisiones examinadoras a los memoristas. Dado que el 
sistema de titulación fue desarrollado en Python con el framework web Django y la base de 
datos relacional PostgreSQL, la extensión del sistema de asignación se realizará
utilizando las mismas tecnologías.
...
tercera es la integración con el Sistema de Monitoreo de Memorias y la cuarta es el 
despliegue de la solución en los servidores del DCC.
...
\subsection{Integración con el Sistema de Monitoreo de Memorias}
Para integrar las comisiones examinadoras en el Sistema de Monitoreo de Memorias, primero
se cambiará el archivo CSV generado por el módulo de asignación de comisiones examinadoras
para que tenga las columnas y el formato solicitados por el SMM.

Para hacer la exportación de las comisiones examinadoras al Sistema de Monitoreo de 
...
Sistema de Monitoreo de Memorias se agregará la opción de importar las comisiones 
desde esta API.

\subsection{Despliegue de la solución}
Por último, la solución desarrollada se desplegará en los servidores de DCC para que 
