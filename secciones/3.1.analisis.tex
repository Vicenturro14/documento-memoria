...
Durante el desarrollo de la herramienta, se realizaron cambios al modelo de datos que no
se planificaron inicialmente. A continuación se detallará las modificaciones realizadas
por cada módulo y la razón por la que se realizaron.

En primer lugar, en el módulo de titulación se agregó el atributo tema a la entidad
Propuesta, que corresponde al tema de la memoria. Se agregó este atributo, puesto que
