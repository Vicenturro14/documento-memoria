\section{Diseño}\label{sec:disenno}
\subsection{Diseño de Mockups}\label{subsec:disenno:mockups}
...
\subsubsection{Interfaz principal del módulo de comisiones examinadoras}
\label{subsec:disenno:mockups:comisiones}
...
\subsubsection{Ficha de un estudiante con comisión asignada}
