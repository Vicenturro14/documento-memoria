...
mediante una consulta POST al de Sistema de Seguimiento de Memorias, para lo cual se le creó una API REST.
Además, las implementaciones realizadas al Sistema de Titulación y al Sistema de Seguimiento de Memorias
